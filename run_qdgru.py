...
def main():
    ...
    print("=" * 60)
    print("Quantum Decomposition GRU (QDGRU)")
    print("=" * 60)

    save_dir = os.path.join(BASE_DIR, "qdgru")
    ...
    run = wandb.init(
        ...
        name="QDGRU",
        config=run_config,
        tags=["quantum", "qdgru", "novel"],
        reinit=True,
    )

    trainer = Trainer(model, run_config, save_dir, run_name="qdgru")
    ...
    art = wandb.Artifact("qdgru_best", type="model")
